<?php
        ...
        /** getGooSpreadsheet.php
        * @author Pierre Romera - pierre.romera@gmail.com
        * @version 1.0
        * @desc Charge une feuille de calculs Google et la retourne au format JSON
        */
